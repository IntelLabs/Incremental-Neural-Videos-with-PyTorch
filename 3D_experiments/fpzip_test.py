...
batch_size = 1     # Note: the larger the batch, the more compression
args.basedir = basedir = '/playpen-ssd2/mikewang/incremental_neural_videos/META_data/flame_salmon_1/down_2x/'
args.expname = expname = 'META_flame_salmon_1_warmup10k_iter10k_s3_stability0_relu_l2_freeze120'
args.mid_freeze_start = 3
freeze_start = 120    # the first frame after freezing the color layers, used to load color layers
...
for frame_base in range(freeze_start, 301, batch_size):
