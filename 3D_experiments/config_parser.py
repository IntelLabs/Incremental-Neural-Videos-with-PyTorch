def config_parser():
    ...
    parser.add_argument("--sample_dynamic_more", action='store_true')
    ...
    parser.add_argument("--i_iter_img", type=int, default=10000000,
                        help='save image during training for a frame')
    parser.add_argument("--no_skip_connect", action='store_true',
                        help='do not use skip connection')
    ...
    parser.add_argument("--i_weights", type=int,
                        help='iter per frame')
    parser.add_argument("--i_weights_warmup", type=int,
                        help='iter per frame before freezing')
    ...
    # little falls args
    parser.add_argument("--start_frame",   type=int, default=360,
                        help='start frame number')
    # parser.add_argument("--full_training", action='store_true',
    #                     help='train with full NeRF iterations')

    # stabilization
    parser.add_argument("--stablize_iter_prob", help='chance of using stabilization during an iteration',
                        default=0., type=float)
    parser.add_argument("--stabilize_start_frame", type=int, help='frame to start stabilizer')
    parser.add_argument("--freeze_start_frame", type=int, help='frame to start color freeze')
    parser.add_argument("--mid_freeze_start", type=int, help='freeze starting from which layer')
    parser.add_argument("--mid_freeze_end", type=int, help='number of layers of backbone (mid layers before heads)')
