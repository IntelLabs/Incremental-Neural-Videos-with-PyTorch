...
base_folder_list = [f'{root_dir}' + 'META_flame_salmon_1_warmup10k_iter10k_s3_stability0_relu_l2_freeze120/']
base_folder_list.append(f'{root_dir}' + 'META_flame_salmon_1_warmup10k_iter10k_s3_stability0_relu_l2_freeze120/')
results_folder = ['nerf_esti', 'compressed_struct_weights_180']
...
for i, base_folder in enumerate(base_folder_list):
    ...
    out[results_folder[i]]['nerf_psnr_list'] = inv_psnr_list
    out[results_folder[i]]['nerf_LPIPS_list'] = inv_LPIPS_list
    out[results_folder[i]]['expname'] = expname
